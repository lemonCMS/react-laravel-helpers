                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    return _context.abrupt("return", new Promise(function (resolve) {
                      ...
                      if (!_this.state.edit) {
                        promise = _this.context.store.dispatch((0, _actions.post)(_this.key, "" + _this.path, payload));
                      } else {
                        promise = _this.context.store.dispatch((0, _actions.update)(_this.key, "" + _this.path, _this.props.params.id, payload));
                      }
