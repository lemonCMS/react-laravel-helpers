(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "lodash/get", "lodash/has", "lodash/map", "lodash/isEmpty", "lodash/isString", "lodash/isArray", "lodash/compact", "react", "react-bootstrap", "./Paginator", "../utils/moment", "../utils/numeral"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("lodash/get"), require("lodash/has"), require("lodash/map"), require("lodash/isEmpty"), require("lodash/isString"), require("lodash/isArray"), require("lodash/compact"), require("react"), require("react-bootstrap"), require("./Paginator"), require("../utils/moment"), require("../utils/numeral"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.get, global.has, global.map, global.isEmpty, global.isString, global.isArray, global.compact, global.react, global.reactBootstrap, global.Paginator, global.moment, global.numeral);
    global.DataTable = mod.exports;
  }
})(this, function (_exports, _propTypes, _get2, _has2, _map2, _isEmpty2, _isString2, _isArray2, _compact2, _react, _reactBootstrap, _Paginator, _moment, _numeral) {
  "use strict";
  ...
  function (_Component) {
    ...
    function DataTable() {
      ...
      _this.renderCols = _this.renderCols.bind(_assertThisInitialized(_this));
      _this.renderRecords = _this.renderRecords.bind(_assertThisInitialized(_this));
      _this.renderRecordCols = _this.renderRecordCols.bind(_assertThisInitialized(_this));
      _this.renderRecordRows = _this.renderRecordRows.bind(_assertThisInitialized(_this));
      _this.renderDropDownItems = _this.renderDropDownItems.bind(_assertThisInitialized(_this));
      _this.renderPaginator = _this.renderPaginator.bind(_assertThisInitialized(_this));
    ...
    _proto.getValue = function getValue(record, col, key) {
      ...
      if ((0, _has2.default)(col, 'checkbox')) {
        ...
        return _react.default.createElement("input", {
          ...
          type: "checkbox",
          onChange: click,
          defaultChecked: (0, _get2.default)(record, (0, _get2.default)(col, 'show'), false)
        });
      }
      ...
      if ((0, _has2.default)(col, 'show') && !(0, _has2.default)(col, 'onClick') && !(0, _has2.default)(col, 'edit')) {
        if ((0, _isString2.default)(col.show)) {
          if ((0, _has2.default)(col, 'translate')) {
            ...
            cell.push(_react.default.createElement("span", {
              key: "'show'"
            }, (0, _moment.default)((0, _get2.default)(record, col.show, '')).format('YYYY-MM-DD')));
          } else if ((0, _has2.default)(col, 'filter') && col.filter === 'dateTime') {
            cell.push(_react.default.createElement("span", {
              key: "'show'"
            }, (0, _moment.default)((0, _get2.default)(record, col.show, '')).format('YYYY-MM-DD HH:mm')));
          } else {
            cell.push(_react.default.createElement("span", {
              key: "'show'"
            }, (0, _get2.default)(record, col.show, '')));
  ...
  Object.defineProperty(DataTable, "contextTypes", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: {
