...
function createAllParamsForFetch(state) {
  ...
  var params = _lodash2.default.assign(_lodash2.default.get(state, ['routesState', 'routes', pathname, 'form'], {}), _qs2.default.parse(_lodash2.default.get(state, ['routing', 'location', 'search'], '').substr(1)));
      ...
      _createClass(StateConnection, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
          if (this.props.routing.location.pathname === nextProps.routing.location.pathname) {
            if (!_lodash2.default.isEqual(this.state, nextProps.routing.location.state)) {
              if (_lodash2.default.isObject(nextProps.routing.location.state)) {
        ...
        value: function pushStateAttempt() {
          if (path === null) {
            path = _lodash2.default.get(this.props.routing, 'location.pathname');
          }
          ...
          if (q.length > 0) {
            ...
            this.context.router.history.push({
              pathname: path,
              search: _qs2.default.stringify(_lodash2.default.omit(this.state.form, ['t'])),
              state: this.state
            });
          } else {
            var d = new Date();
