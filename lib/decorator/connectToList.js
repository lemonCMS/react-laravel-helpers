...
var _store = require('../redux/modules/store');

var _DataTable = require('../components/Data/DataTable');
...
var _Search = require('../components/Fields/Search');

var _Search2 = _interopRequireDefault(_Search);

var _Pending = require('../components/Pending/Pending');
...
function connnectToList(properties) {
  return function (WrappedComponent) {
    ...
    var Connection = (_dec = (0, _reduxConnect.asyncConnect)([{
      promise: function promise(_ref) {
        ...
        promises.push(dispatch((0, _store.load)(properties.key, api(), state)));
        // }
      ...
      _createClass(Connection, [{
        ...
        value: function componentWillUpdate(nextProps) {
          if ((0, _get3.default)(nextProps, ['data', 'item', 'deleted'], false) === true) {
            this.props.dispatch((0, _store.clearItem)(properties.key));
        ...
        value: function filter() {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_Search2.default, { pushSearch: this.props.pushSearch, inputOnStack: this.props.inputOnStack, query: this.props.inputOnStack('q') })
            )
          );
        }
      }, {
        ...
        value: function destroy(item) {
          this.props.dispatch((0, _store.destroyItem)(this.state.path, '' + properties.api, item.id));
        }
      }, {
        key: 'render',
