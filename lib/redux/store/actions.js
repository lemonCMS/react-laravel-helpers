...
function isLoaded(key, globalState) {
  ...
  var check = (0, _get3.default)(globalState, [constants.reducerIndex, key, 'success'], false) === true && parseInt((0, _get3.default)(globalState, [constants.reducerIndex, key, 'list', 'current_page'], 1), 10) === parseInt((0, _get3.default)(params, 'page', 1), 10) && JSON.stringify(params) === JSON.stringify((0, _get3.default)(Allparams, key, {}));

  (0, _set3.default)(Allparams, key, JSON.parse(JSON.stringify(params)));
  return check;
}
