(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "lodash/get", "lodash/has", "lodash/flatten", "lodash/cloneDeep", "lodash/isFunction", "react-redux", "react-bootstrap", "react-router-dom", "@wicked_query/redial", "../redux/store/actions", "../components/DataTable", "./connectToFilter", "./connectToConfirm", "../components/Search", "../components/Pending"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("lodash/get"), require("lodash/has"), require("lodash/flatten"), require("lodash/cloneDeep"), require("lodash/isFunction"), require("react-redux"), require("react-bootstrap"), require("react-router-dom"), require("@wicked_query/redial"), require("../redux/store/actions"), require("../components/DataTable"), require("./connectToFilter"), require("./connectToConfirm"), require("../components/Search"), require("../components/Pending"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.get, global.has, global.flatten, global.cloneDeep, global.isFunction, global.reactRedux, global.reactBootstrap, global.reactRouterDom, global.redial, global.actions, global.DataTable, global.connectToFilter, global.connectToConfirm, global.Search, global.Pending);
    global.connectToList = mod.exports;
  }
})(this, function (_exports, _propTypes, _react, _get2, _has2, _flatten2, _cloneDeep2, _isFunction2, _reactRedux, _reactBootstrap, _reactRouterDom, _redial, _actions, _DataTable, _connectToFilter, _connectToConfirm, _Search, _Pending) {
  "use strict";
    ...
    return function (WrappedComponent) {
      ...
      function (_Component) {
        ...
        _proto.render = function render() {
          ...
          rows[0].cols = (0, _flatten2.default)([rows[0].cols, [dropDown]]);
