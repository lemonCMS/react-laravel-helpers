(function (global, factory) {
  ...
  function createAllParamsForFetch(state) {
    ...
    var params = (0, _assign2.default)((0, _get2.default)(state, ['routesState', 'routes', pathname, 'form'], {}), _qs.default.parse((0, _get2.default)(state, ['routing', 'location', 'search'], '').substr(1)));
    ...
    return function (WrappedComponent) {
      ...
      function (_Component) {
        ...
        function StateConnection() {
          ...
          _this.pushOnState = _this.pushOnState.bind(_assertThisInitialized(_this));
          _this.pushStateAttempt = _this.pushStateAttempt.bind(_assertThisInitialized(_this));
          _this.pushSearch = _this.pushSearch.bind(_assertThisInitialized(_this));
          ...
          _this.toggleOnStack = _this.toggleOnStack.bind(_assertThisInitialized(_this));
          _this.inputOnStack = _this.inputOnStack.bind(_assertThisInitialized(_this));
          _this.onStack = _this.onStack.bind(_assertThisInitialized(_this));
          _this.sortOnStack = _this.sortOnStack.bind(_assertThisInitialized(_this));
          _this.removeFromState = _this.removeFromState.bind(_assertThisInitialized(_this));
          _this.alphabet = _this.alphabet.bind(_assertThisInitialized(_this));
          _this.alphaFilter = _this.alphaFilter.bind(_assertThisInitialized(_this));
